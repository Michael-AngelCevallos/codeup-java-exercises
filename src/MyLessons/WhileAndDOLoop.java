...
//        }
        ...
        Scanner scanner = new Scanner(System.in); // inputs scanner to ask questions in console
        ...
        // WHILE LOOP first check condition then executes code if condition is true
        ...
        // DO loop will always perform block of code at least once, AND THEN checks condition after
        do{
            System.out.print("Enter your name: ");// .print--- will keep asking if you press enter/ .println --- will ask again but has delay
            name = scanner.nextLine(); //  stores the result of what we put
        } while(name.isBlank());
