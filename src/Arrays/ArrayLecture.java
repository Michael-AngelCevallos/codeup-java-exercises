...
//         nums[10] = 5; // accessing an index out of bounds throws a runtime exception
        ...
        System.out.println(pets[2]);// returns Snickers
         ...
         */
//        double[] numbers = {1.5, 2.5, 3.5, 4.5, 5.5};// array initializer syntax
////
//        System.out.println(numbers[0]);// prints 1.5

        /** ADD the numbers Array */
//        double total = 0;// IMPORTANT, need to make variable of total in order to add
//
...
//        System.out.println(total);
        ...
        //Prints id's
//            for(double i = 0; i < numbers.length; i += 1){
//                System.out.println(numbers); // prints id 5 times
//            }
...
//             Person[] people = new Person("Fred", 88);
